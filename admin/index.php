...
if (isset($_POST['btn'])) {
    ...
    $obj_admin = new Admin();
    $message = $obj_admin->admin_check_login($_POST);
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <!--[if lt IE 9]>
                ...
                <link id="ie-style" href="../assets/admin_assets/css/ie.css" rel="stylesheet">
        <![endif]-->

        <!--[if IE 9]>
                <link id="ie9style" href="../assets/admin_assets/css/ie9.css" rel="stylesheet">
        <![endif]-->
                        ...
                        <form class="form-horizontal" action="index.php" method="post">
                            <fieldset>
                                ...
                                <div class="input-prepend" title="Username">
                                    ...
                                    <input class="input-large span10"  name="email_address" id="email" type="text" placeholder="type Email address"/>
                                </div>
                                <div class="clearfix"></div>

                                <div class="input-prepend" title="Password">
                                    <span class="add-on"><i class="halflings-icon lock"></i></span>
                                    <input class="input-large span10" name="password" name="password" id="password" type="password" placeholder="type password"/>
                                </div>
                                <div class="clearfix"></div>
