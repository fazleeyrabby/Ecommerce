...
$message = '';
if (isset($_POST['btn'])) {
    $message = $obj_super_admin->save_manufacture_info($_POST);
}
?>
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <fieldset>
                                ...
                                <div class="control-group hidden-phone">
                                    ...
                                    <div class="controls">
                                        <textarea class="cleditor" name="manufacture_dcrpton" id="textarea2" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="reset" name="cancle_btn" class="btn">Cancel</button>
                                </div>
                            </fieldset>
                        </form>   
